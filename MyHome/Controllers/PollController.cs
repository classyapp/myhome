        ...
        private void PollController_OnListingLoaded(object sender, ListingLoadedEventArgs<PollMetadata> listingLoadedEventArgs)
        {
            ...
            listingLoadedEventArgs.ListingDetailsViewModel.ExtraData = new PollViewExtraData {
                ...
                EndDate = listingLoadedEventArgs.ListingDetailsViewModel.Metadata.EndDate.HasValue ? 
                    (DateTime?)Convert.ToDateTime(listingLoadedEventArgs.ListingDetailsViewModel.Metadata.EndDate.Value, System.Globalization.CultureInfo.InvariantCulture) : null
            };
        }
